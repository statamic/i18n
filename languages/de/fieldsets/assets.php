...
return [
    ...
    'image_manipulation_route_instruct' => 'Die URL, über die die manipulierten Bilder ausgeliefert werden. Wenn die gecacheten Bilder direkt ausgeliefert werden, sollte diese URL dem Cache-Pfad entsprechen.', // 'The URL where your resizable image assets will be served. If serving cached images directly, this should be the URL of the cached path.'
    ...
    'auto_crop_instruct' => 'Sollten Bilder automatisch zugeschnitten werden? Der Fokus-Punkt wird verwendet, falls definiert.', // 'Should images be automatically cropped? Their focal points will be used, if specified.'

    'image_manipulation_driver' => 'Bild-Manipulations Treiber', // 'Image Manipulation Driver'
    'image_manipulation_driver_instruct' => "ImageMagick kann in gewissen Situation schneller sein, ist aber nicht auf allen Servern verfügbar.", // "In some cases ImageMagick can be faster, but isn't available on all servers."
