...
return [
    ...
    'globals_slug_instructions' => "C'est la variable utilisée dans vos modèles. Par exemple : <code>contenu_du_pied_de_page</code> ou <code>parametres_barre_laterale</code>.",
    ...
    'display_name' => "Etiquette affichée",
