...
return [
    ...
    */
    ...
    "required_with"        => "Le champ :attribute est obligatoire quand :values est présent(e).",
    "required_with_all"    => "Le champ :attribute est obligatoire quand :values est présent(e).",
    "required_without"     => "Le champ :attribute est obligatoire quand :values est absent(e).",
    "required_without_all" => "Le champ :attribute est obligatoire quand tous(tes) :values sont absent(e)s.",
