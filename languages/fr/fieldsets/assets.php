...
return [
    ...
    'image_manipulation_route_instruct' => 'L\'URL à laquelle vos ressources d\'images redimensionnables seront disponibles. Si vous servez directement des images en cache, ceci doit être l\'URL du chemin du cache.',
    ...
    'image_manipulation_cached' => 'Sert directement des images en cache',
    'image_manipulation_cached_instruct' => 'Les images doivent-elles être générées avant qu\'elles soient appelées ? [En savoir plus](https://docs.statamic.com/reference/tags/glide#serving-cached-images)',

    'image_manipulation_cached_path' => 'Chemin des images en cache',
