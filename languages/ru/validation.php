...
return [
    ...
    */
    ...
    "required_with"        => "Поле :attribute обязательно когда :values равен present.",
    "required_with_all"    => "Поле :attribute обязательно когда :values равен present.",
    "required_without"     => "Поле :attribute обязательно когда :values равен нечему.",
    "required_without_all" => "Поле :attributeтребуется, если ни один из :values присутствуют.",
