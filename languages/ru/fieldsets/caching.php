...
return [
    ...
    'cache_tags' => 'Теги кеша',
    'cache_tags_instruct' => 'Тег {{ cache }} кеша, позволяют кэшировать разделы ваших шаблонов.',

    'cache_tags_enabled' => 'Задействован',
    'cache_tags_enabled_instruct' => 'Для проверки задействованы ли теги на самом деле. Отключение этого параметра применяется ко всем тегам.',
